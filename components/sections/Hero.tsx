        ...
        <div className="mx-auto max-w-4xl bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-12 sm:p-16 border border-gray-100">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-[var(--color-text-muted)] mb-8 leading-relaxed max-w-2xl mx-auto animate-fade-in-delay-1">
              Turn your vibe coding, vibe contracting, vibe designing session into detailed briefs for freelancers.
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-delay-3">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-[var(--color-ghostteam-black)] text-[var(--color-ghostteam-black)] hover:bg-[var(--color-ghostteam-black)] hover:text-white px-8 py-6 text-lg font-semibold rounded-full transition-all duration-300 hover:scale-105"
                asChild
              >
                <a href="/freelancers">I&apos;m a freelancer</a>
              </Button>
            </div>
          </div>
        </div>
